        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2">
          <Reveal>
            <div className="h-full rounded-2xl border border-line px-8 py-9">
              ...
              <p className="mt-3 text-ink">{SITE.address}</p>
              ...
              <ul className="mt-4 flex flex-col gap-3 text-ink">
                ...
                <li>
                  <a
                    ...
                    className="sweep-link inline-flex items-center gap-1"
                  >
                    <IconPhone size={16} aria-hidden /> {SITE.phoneDisplay}
                  </a>
                </li>
              </ul>
            </div>
