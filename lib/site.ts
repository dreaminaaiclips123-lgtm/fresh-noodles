...
export const SITE = {
  ...
  address: "Sunset Mall, inside Sunset Compound, Cairo, Egypt",
  instagram: "https://www.instagram.com/freshnoodles.eg",
  facebook: "https://www.facebook.com/profile.php?id=61563865457433",
  // No posted hours on Facebook (shows only "Open now") — plausible delivery
  // window for a mall-based dark kitchen, flagged in PRODUCT.md for the owner to correct.
