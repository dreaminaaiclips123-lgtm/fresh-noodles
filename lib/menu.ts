...
// image/imagePosition point at real Fresh Noodles photos (from their
// Facebook page), cropped to the plate that actually matches each dish —
// never a stand-in photo for something it isn't.
...
export const ALL_ITEMS: MenuItem[] = [...FEATURED, ...MENU.flatMap((c) => c.items)];
